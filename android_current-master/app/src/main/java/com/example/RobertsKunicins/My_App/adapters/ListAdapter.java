package com.example.RobertsKunicins.My_App.adapters;
...
public class ListAdapter extends BaseAdapter {
    ...
    Context context;
    ArrayList<Ssomething> penguinList;

    public ListAdapter(Context context, ArrayList<Ssomething> penguinList) {
